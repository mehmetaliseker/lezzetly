...
export default function OwnerAccountPage() {
	...
	const canRenderPasswordFields = Boolean(user) && user?.role === UserRolePath.OWNER && profilePasswordChangeEnabled;
		...
		<div className="flex min-h-0 flex-1 flex-col bg-stone-950">
			<PageContainer maxWidth="site" className="flex flex-1 py-10 sm:py-14">
				<section className="w-full rounded-2xl border border-stone-800 bg-stone-900/80 p-8 shadow-xl">
					...
					<h1 className="mt-2 text-3xl font-semibold text-stone-50">Profili güncelle</h1>
					...
					>
						...
						{canRenderPasswordFields ? (
							<>
								<h2 className="mt-4 border-t border-stone-800 pt-8 text-lg font-semibold text-stone-100 sm:col-span-2">
									Şifre güncelle
								</h2>
