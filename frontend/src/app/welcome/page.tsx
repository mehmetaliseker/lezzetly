		...
		<div className="flex min-h-0 flex-1 flex-col bg-stone-950">
			<PageContainer maxWidth="site" className="flex flex-1 items-center py-10 sm:py-14">
				<section className="w-full rounded-2xl border border-stone-800 bg-stone-900/80 p-8 shadow-xl">
					<p className="text-sm font-semibold uppercase tracking-wide text-stone-400">Landing</p>
					...
					<p className="mt-3 max-w-2xl text-sm leading-relaxed text-stone-400">
						Hesabınız hazır. Profilinizi düzenleyebilir veya rezervasyon sürecine hemen geçebilirsiniz.
					</p>
					<div className="mt-8 flex flex-wrap gap-3">
						<Link
							className="inline-flex min-h-11 items-center justify-center rounded-md border border-stone-600 bg-stone-900 px-6 py-2.5 text-sm font-semibold text-stone-100 transition hover:bg-stone-800"
							href="/profile"
						>
							Profili görüntüle
						</Link>
